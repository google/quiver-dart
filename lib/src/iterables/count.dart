...
/**
 * Returns an infinite [Iterable] of [int]s, starting from [start] and
 * increasing by [step].
 */
Iterable<num> count([int start = 0, int step = 1]) => new _Count(start, step);
...
class _CountIterator implements Iterator<num> {
  ...
  _CountIterator(int this._start, this._step);

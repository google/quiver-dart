 ...
 */
typedef dynamic Loader<K, V>(K key);

/**
 * A semi-persistent mapping of keys to values. All access to a Cache is
 * asynchronous because many implementations will store their entries in
 * remote systems, isolates, or otherwise have to do async IO to read and write.
 */
